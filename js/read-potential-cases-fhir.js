...
(async () => {
  ...
  await fs.writeFile("hypertrophic-cardiomyopathy-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("hypertrophic-cardiomyopathy-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
